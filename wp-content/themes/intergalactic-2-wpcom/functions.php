...
function intergalactic_2_continue_reading_link() {
	return '<a href="'. esc_url( get_permalink() ) . '" class="more-link">' . sprintf( __( 'Узнать подробнее <span class="screen-reader-text">%1$s</span>', 'intergalactic-2' ), esc_attr( strip_tags( get_the_title() ) ) ) . '</a>';
}
